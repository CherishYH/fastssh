...
import com.ylink.fastssh.common.config.SystemConfig;
import com.ylink.fastssh.common.utils.RequestUtil;
import com.ylink.fastssh.common.utils.TextFormaterUtil;
import com.ylink.fastssh.common.web.SessionKey;
import com.ylink.fastssh.project.basic.shiro.common.ConfigConstants;
...
public class CaptchaFormAuthenticationFilter extends FormAuthenticationFilter {
    ...
    protected String getAuthExpMessage( AuthenticationException e ){
        ...
        if(e instanceof UnknownAccountException || e instanceof IncorrectCredentialsException){
            ...
            if( user != null )
                expMsg= TextFormaterUtil.format(user.getLoginTime(),"HH点mm分")
