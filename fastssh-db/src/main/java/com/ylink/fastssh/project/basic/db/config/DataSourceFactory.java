package com.ylink.fastssh.project.basic.db.config;
...
import com.ylink.fastssh.common.execption.ApplicationException;
...
public class DataSourceFactory {
	...
	public DataSource createDataSource(){
		...
		if( config != null && StringUtils.hasText(pool) ){
